...
namespace osu.Desktop
{
    ...
    {
        private const string client_id = "781773248085753886";
        ...
        private void updateStatus()
        {
            ...
            presence.Assets.LargeImageText = $"{user.Value.Username}" + (user.Value.Statistics?.Ranks.Global > 0 ? $" (ранг #{user.Value.Statistics.Ranks.Global:N0})" : string.Empty);
